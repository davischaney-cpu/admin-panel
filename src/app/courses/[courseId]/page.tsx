  ...
  return (
    <DashboardShell email={email} role={role} currentPath="/jobs">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
        ...
        <h2 className="mt-2 text-3xl font-semibold tracking-tight">Course detail retired</h2>
        <p className="mt-4 max-w-2xl text-sm text-zinc-500">
          This route belonged to the old school dashboard. The new product direction is a CRM for leads, quotes, follow-ups, and booked jobs.
        </p>
