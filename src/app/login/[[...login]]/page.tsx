        ...
        <div className="grid lg:grid-cols-[1fr_460px]">
          ...
          <section className="relative bg-[#f7fbff] p-3 sm:p-6">
            <div className="mb-4 rounded-[1.5rem] bg-white px-6 py-5 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
              <p className="text-xs uppercase tracking-[0.3em] text-[#163f87]">Welcome back</p>
              <h2 className="mt-2 text-2xl font-semibold text-slate-900">Sign in to DavyG CRM</h2>
              <p className="mt-2 text-sm text-slate-700">Access your leads, jobs, calendar, and team workspace.</p>
            </div>
